...
def imprimir_mapa(mida,diccionari,x,y):
    ...
    print(f"La teva salut és de: {var_globals.elements.jugador['hp']} punts de vida.")
...
def main():
    ...
    dic_q_elements = var_globals.elements.quantitat_elements(1)
    dic_posicions = var_globals.elements.generar_posicions(amplada,ll_elements,dic_q_elements)
